                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Search restaurant</button>
                        </form>
                    </div>
                    <div class="steps">
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src=""> </a> <span>Order Delivery &amp; Take-Out </span> </div>
