...
<head>
    ...
    <link rel="icon" href="#">
    <title>Food odering systme</title>
    <!-- Bootstrap core CSS -->
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rs 10,00</a> </li>
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from dishes where rs_id='$_GET[res_id]' ORDER BY average_rating DESC");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            ...
                                            <div class="rest-descr">
                                                ...
                                                <p>Rating: <?php  echo $product['average_rating']; ?></p>
                                    ...
                                    <input class="b-r-0" type="number" name="quantity" min='1' oninput="validity.valid|| (value='');" style="margin-left:20px;" value="1" size="2" />
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="i"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: <a href="tel:+977-015560188">015560188</a></h5> </div>
                ...
                <div class="modal-body cart-addon">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs 170</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
