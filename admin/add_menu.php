									...
									if($fsize>=1000000)
									...
									else
										{
                                                ...
                                                if (mysqli_num_rows($result)>0) {
                                                    echo '<script> Dish already added </script>';
                                                }
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">price </label>
                                                     <input type="number" name="price" class="form-control" placeholder="$" min='1' oninput="validity.valid|| (value='');" style="margin-left:20px;" value="1" size="2"> 
