							  ...
							  <form action="" method="post">
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                       ...
                                       <input class="form-control" type="charset"pattern="^\D*$" title="number are not allowed" name="username" id="example-text-input" placeholder="UserName" required> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">First Name</label>
                                       <input class="form-control" type="text" name="firstname" id="example-text-input" placeholder="First Name" pattern="^\D*$" title="number are not allowed" required > 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Last Name</label>
                                       <input class="form-control" type="text" name="lastname" id="example-text-input-2" placeholder="Last Name"pattern="^\D*$" title="number are not allowed" required> 
                                    </div>
                                    <div class="form-group col-sm-6">
